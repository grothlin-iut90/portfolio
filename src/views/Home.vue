                    ...
                    <div class="category-line"></div>
                        ...
                        <div class="technologies-flow">
                            <div
                                    ...
                                    >
                                    <div class="bubble-glow" v-if="language && language.name"></div>
                                    <img
                                            v-if="language && language.name"
                                            :src="require(`@/assets/skills/${language.name}.svg`)"
                                            :alt="language.name"
                                            />
                                    <span v-if="language && language.name">{{ language.name }}</span>
                            </div>
                        </div>
                </div>
            </div>
    ...
    export default {
        ...
        data() {
            return {
                ...
                isLoading: false,
                status: null, // { type: 'success' | 'error', text: 'message' }
            };
        },
        mounted() {
            setTimeout(() => {
        ...
        methods: {
            ...
            handleSubmit() {
                this.isLoading = true;
                this.status = null; // Clear previous status
                ...
                fetch("/", {
                    ...
                    .then((response) => {
                        ...
                        if (response.ok) {
                            this.status = {
                                type: "success",
                                text: this.$t("ContactSection.success"), // Ensure this translation key exists
                            };
                            // Reset form fields
                            this.formData.name = "";
                            this.formData.email = "";
                            this.formData.message = "";
                            this.showForm = false; // Optionally close the form on success
                        } else {
                    ...
                    .catch((error) => {
                        ...
                        this.status = {
                            type: "error",
                            text: this.$t("ContactSection.error"), // Ensure this translation key exists
                        };
                    });
            },
        },
